...
//    }
    ...
    private void loadRevenueData() {
        ...
        for (OrderItem item : filteredOrderItems) {
            totalRevenue += item.getTotalAmount();
            lineEntries.add(new Entry(index++, totalRevenue));
        }
        ...
        // Thiết lập ValueFormatter cho giá trị
        lineDataSet.setValueFormatter(new CurrencyValueFormatter());
        ...
        adapter_revanue = new Adapter_revanue(filteredOrderItems);
        recyclerView.setAdapter(adapter_revanue);
    }
